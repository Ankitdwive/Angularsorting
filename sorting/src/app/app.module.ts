...
@NgModule({
  declarations: [
    ...
    RefrenceComponent,
    RecComponent,
    HotlistComponent,SendmsgComponent, EditComponent, ProjectComponent, FilterComponent, FilterpipePipe, CallreportComponent, HistorymComponent,
  //  SendmsgComponent
  ],
  imports: [
    BrowserModule,
    ...
    MatAutocompleteModule,MatNativeDateModule,FormsModule,MatRadioModule
  ],
